    ...
    <div className="bg-white min-h-screen" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <section className="py-12 bg-slate-50">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            Formal user research with brokers wasn't part of the engagement; discovery was conducted with internal subject matter experts who understood the product domain but weren't always empowered to make decisions on behalf of the business. Sessions typically involved SMEs walking us through the rules governing the quote flow — several of which were designed to detect and deter soft fraud rather than being standard product requirements — the typical dynamics between broker agents and prospective customers at the point of submission, and the full requirements across new business and renewal journeys. The existing solution provided a useful reference point: brokers and agents were filling out paper forms and calling customers directly, with no self-service capability at all. That baseline made the design direction clear even without direct broker access; the challenge was getting the details right without the usual feedback loops.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <p className="text-lg text-slate-500 leading-relaxed mb-6">
            My response was to design defensibly. Rather than waiting for consensus that rarely came, I documented the rationale behind every significant decision so it could survive a challenge without depending on memory of what was agreed. When requirements were genuinely ambiguous, I made the more conservative choice and flagged the assumption explicitly. When the cycle of late-stage demo changes threatened delivery, I escalated to the project manager and introduced a process change: SMEs were required to sign off directly on individual Jira tickets before they could be closed, creating a paper trail that made reversals visible and accountable. It didn't eliminate the dysfunction but it reduced the churn and kept engineering on track.
          </p>
          <p className="text-lg text-slate-500 leading-relaxed mb-6">
            The white-label requirement added a third constraint. The carrier was reluctant to interface directly with its broker clients, which meant we were building theming tooling for brands we had never spoken to. We handled it the same way: define the configurable surface clearly, limit partner theming to brand colour, typography, illustration, and content rules, and build the tooling flexible enough that brokers could self-configure within those bounds without needing a designer in the room.
          </p>
          <p className="text-lg text-slate-500 leading-relaxed">
        ...
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              { metric: 'BAU', label: 'Ongoing platform maintenance handed to an advisory team from June 2026; active implementation complete.' },
            ].map(({ metric, label }) => (
              <div key={metric}>
