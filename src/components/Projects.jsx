...
const projects = [
  ...
  },
  {
    ...
    description: 'In partnership with the Neurophysiology Department at Children\'s Health Ireland, redesigning the end-to-end experience for families preparing for paediatric EEG scans. Research-led service design addressing a 15% appointment slot loss rate.',
  ...
  },
  {
    ...
    description: 'A structured journey mapping session with front-end developers to surface and document the systemic friction in the design-to-development handoff. Session format shared with teams in Dublin, Kuala Lumpur, and Toronto.',
...
const moreWork = [
  {
    ...
    description: 'A NotebookLM-powered tool that automates WCAG 2.0 contrast auditing from a single JSON token file, automating colour extraction across 25+ white-label brands.',
